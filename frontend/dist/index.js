...
(function(exports) {
  ...
  var board = function (w) {
      return function (h) {
          ...
          throw new Error("Failed pattern match at Battleship line 41, column 1 - line 43, column 78: " + [ w.constructor.name, h.constructor.name ]);
      };
  };
  exports["board"] = board;
})(PS["Battleship"] = PS["Battleship"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var Text_Smolder_Markup = PS["Text.Smolder.Markup"];        
  var boardToHtml = function (v) {
      if (v instanceof Data_Maybe.Nothing) {
          return Text_Smolder_HTML.table(Text_Smolder_Markup.text(""));
      };
      if (v instanceof Data_Maybe.Just) {
          var cell = function (i) {
              return function (j) {
                  return Text_Smolder_Markup["with"](Text_Smolder_Markup.attributableMarkupMF)(Text_Smolder_HTML.td)(Text_Smolder_HTML_Attributes.className("cell"))(Text_Smolder_Markup.text(Data_Show.show(Data_Show.showInt)(i) + (", " + Data_Show.show(Data_Show.showInt)(j))));
              };
          };
          var row = function (i) {
              return Text_Smolder_HTML.tr(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Text_Smolder_Markup.monoidMarkup)(cell(i))(Data_Array.range(0)(v.value0.width)));
          };
          return Text_Smolder_HTML.table(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Text_Smolder_Markup.monoidMarkup)(row)(Data_Array.range(0)(v.value0.height)));
      };
      throw new Error("Failed pattern match at Draw line 14, column 1 - line 15, column 1: " + [ v.constructor.name ]);
  };
  exports["boardToHtml"] = boardToHtml;
})(PS["Draw"] = PS["Draw"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
...
(function(exports) {
  ...
  var main = (function () {
      var html = Text_Smolder_Renderer_String.render(Draw.boardToHtml(Battleship.board(5)(10)));
